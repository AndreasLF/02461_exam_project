...
# # MNIST dataset
# train_dataset = torchvision.datasets.MNIST(root='data/Data-Epidemiologiske-Rapport-04012021-ja21/Test_pos_over_time1.csv',
#                                            train=True, 
...
torch_X_train = torch.from_numpy(X_train).type(torch.LongTensor).to(device)
...
test_dataset = torch.utils.data.TensorDataset(torch_X_test,torch_y_test)
